...
// --- 2. AMBIL DATA DINAMIS UNTUK KARTU (TERMASUK FOTO) ---
...
// Query untuk mengambil data profil santri (termasuk foto)
$sql_profil = "SELECT 
...
if ($result_profil->num_rows > 0) {
    ...
    $file_foto_santri = $data_profil['foto']; // Ambil nama file foto
    $_SESSION['nama_lengkap'] = $nama_santri; // Simpan nama di session
}
$stmt_profil->close();
...
<head>
    ...
    <style>
        ...
        *, *:before, *:after {
        ...
        .dashboard-grid {
            display: grid;
            /* Layout grid baru (dari kode Anda sebelumnya) */
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            <li class="active"><a href="dashboard_santri.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        ...
        <main class="dashboard-area">
            ...
            <div class="dashboard-grid">
                ...
                <div class="card card-chart">
                    ...
                    <canvas id="myChart" style="max-height: 250px; min-height: 250px;"></canvas>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!sessionStorage.getItem('dashboardWelcomed')) {
                Swal.fire({
                    ...
                    text: `Halo, ${namaSantri}. Selamat belajar.`,
                    icon: 'success',
                    timer: 2500,
