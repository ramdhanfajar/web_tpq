...
// Status default kosong (akan diisi saat redirect)
$status_msg_php = ''; 

// --- 2. AMBIL DATA SANTRI (UNTUK HEADER) ---
$nama_santri = "Santri";
$file_foto_santri = null;
...
// --- 3. LOGIKA SIMPAN PASSWORD BARU (POST) ---
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Pastikan nama file ini 'ganti_password_santri.php'
    header("Location: ganti_password_santri.php?status=" . $status_msg_php);
    exit();
}
...
<head>
    ...
    <title>Ganti Password - <?php echo htmlspecialchars($nama_santri); ?></title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="informasi_nilai.php"><i class="fas fa-chart-bar"></i> Informasi Nilai</a></li>
            <li class="active"><a href="ganti_password_santri.php"><i class="fas fa-lock"></i> Ganti Password</a></li>
    ...
    <div class="main-content">
        ...
        <main class="dashboard-area">
            ...
            <div class="card-form">
                ...
                <form action="ganti_password_santri.php" method="POST" id="change-password-form">
                    ...
                    <div class="form-footer">
                        <a href="dashboard_santri.php" class="btn btn-batal">Batal</a>
    ...
    <script>
        ...
        // --- 4. JS Pop-up Status (PERBAIKAN UTAMA) ---
        document.addEventListener('DOMContentLoaded', function() {
            // Ambil status dari URL (bukan dari PHP variabel echo)
            ...
            if (status === 'sukses') {
                ...
                Swal.fire('Gagal!', 'Password Lama salah.', 'error');
                 ...
                 Swal.fire('Error', 'Terjadi kesalahan pada database.', 'error');
            }
        });
