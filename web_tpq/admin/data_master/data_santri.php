...
// --- 2. AMBIL DATA SANTRI UNTUK TABEL ---
// Kita JOIN dengan tabel kelas untuk mendapatkan nama kelasnya
$sql = "SELECT s.id, s.nis, s.nama_lengkap, s.nama_wali, s.no_telepon_wali, k.nama_kelas 
        FROM data_santri s 
...
<head>
    ...
    <title>Master Data Santri - Admin</title>
    ...
    <style>
        ...
        *, *:before, *:after {
        ...
        /* --- CSS Sidebar & Header (Sama seperti dashboard_admin.php) --- */
        ...
        /* Style untuk li.active (menu aktif) */
        ...
        .card-table {
            ...
            overflow: hidden; /* Penting agar tabel tidak merusak border radius */
        }
        ...
        .search-bar input {
            padding: 10px 15px 10px 40px; /* Jarak untuk ikon */
        ...
        .card-body {
            padding: 0; /* Hapus padding agar tabel pas */
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item dropdown active">
                <a href="#" class="dropdown-toggle active"> <span><i class="fas fa-database fa-fw"></i> Master Data</span>
                    <i class="fas fa-chevron-down toggle-icon"></i>
                </a>
                <ul class="submenu active"> <li class="active-sub"><a href="data_santri.php">Santri</a></li>
        ...
        <main class="dashboard-area">
            ...
            <div class="card-table">
                <div class="card-header">
                    <a href="tambah_santri.php" class="btn-tambah">
                ...
                <div class="card-body">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php $no = 1; foreach ($data_santri as $santri): ?>
                                <tr>
                                    <td><?php echo $no++; ?>.</td>
                                    ...
                                    <td><?php echo htmlspecialchars($santri['nama_wali']); ?></td>
                                    <td><?php echo htmlspecialchars($santri['no_telepon_wali']); ?></td>
                                    <td>
                                        <a href="edit_santri.php?id=<?php echo $santri['id']; ?>" class="btn-aksi btn-edit"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        <a href="hapus_santri.php?id=<?php echo $santri['id']; ?>" class="btn-aksi btn-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus santri ini?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
    ...
    <script>
        ...
        document.querySelectorAll('.dropdown-toggle').forEach(function(toggle) {
            toggle.addEventListener('click', function(e) {
                ...
                // Buka dropdown yang diklik (jika sebelumnya tidak aktif)
                if (!isAlreadyActive) {
