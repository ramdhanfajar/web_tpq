...
// --- 2. AMBIL DATA GURU UNTUK TABEL ---
// Kita JOIN dengan tabel users untuk mendapatkan email
$sql = "SELECT dp.id, dp.nip, dp.nama_lengkap, dp.no_telepon, u.email 
...
<head>
    ...
    <style>
        /* --- (CSS SAMA PERSIS DENGAN data_santri.php) --- */
        :root {
            --warna-hijau: #00a86b;
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item dropdown active">
                ...
                <ul class="submenu active">
                    ...
                    <li class="active-sub"><a href="data_guru.php">Guru</a></li>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_guru.php?id=<?php echo $guru['id']; ?>" class="btn-aksi btn-edit"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        <a href="hapus_guru.php?id=<?php echo $guru['id']; ?>" class="btn-aksi btn-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus guru ini?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
